...
export default function CampaignsPro() {
  ...
  return <div className="space-y-4">
    <section className="page-heading"><div><p className="section-kicker">Gerenciador</p><h1>Campanhas e anúncios</h1><p>Navegue da campanha até o anúncio individual mantendo BM, conta e período fixos. O status de campanha consulta a entrega atual da Meta.</p></div><button className="secondary-button" onClick={() => { void load(true); }} disabled={loading}><RefreshCw size={14} className={loading ? 'animate-spin' : ''} />Atualizar agora</button></section>
